Ext.define("Compass.ErpApp.Desktop.Applications.UserManagement.UserApplicationMgtPanel", {
    ...
    saveApplications: function () {
        ...
        var appsJson = {
            "app_ids[]": appIds,
            "desktop_applications": this.initialConfig['desktopApplications'],
    ...
    constructor: function (config) {
        var availableApplicationsStore = Ext.create('Ext.data.TreeStore', {
            proxy: {
                ...
                extraParams: {
                    ...
                    desktop_applications: config['desktopApplications']
                }
            },
            root: {
        ...
        this.available_applications_tree = Ext.create('Ext.tree.TreePanel', {
