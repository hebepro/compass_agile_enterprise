    ...
    constructor: function (config) {
        ...
        config['items'] = [
            ...
            },
            {
                ...
                itemTpl: [
                    '<tpl if="!scheduled">',
                    '<div style="float:right;margin-right:50px;"><img src="/assets/erp_app/mobile/yellow_light.png" /></div>',
                    '<tpl elseif="next_run_at &gt; new Date()">',
                    '<div style="float:right;margin-right:50px;"><img src="/assets/erp_app/mobile/green_light.png" /></div>',
                    '<tpl else>',
                    '<div style="float:right;margin-right:50px;"><img src="/assets/erp_app/mobile/red_light.png" /></div>',
                    '</tpl>',
