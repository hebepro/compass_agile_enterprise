Ext.define("Compass.ErpApp.Shared.InventoryMgt.InventoryTxnHistoryGrid", {
    extend: "Ext.grid.Panel",
    alias: 'widget.inventory_txn_history_grid',
    frame: false,
    autoScroll: true,
    loadMask: true,
     ...
     */
    searchDescription: 'Find Transaction',
    ...
    initComponent: function () {
        ...
        columns = [

            {
                ...
                renderer: function (v) {
                    switch (v) {
                        case 'InventoryPickupTxn':
                            return 'Pickup';
                            break;
                        case 'InventoryDropoffTxn':
                            return 'Dropoff';
                            break;
                        default:
                            return 'BizTxnEvent'
