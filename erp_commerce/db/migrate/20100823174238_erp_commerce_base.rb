class ErpCommerceBase < ActiveRecord::Migration
  def self.up
    ...
    add_column :product_types, :available_on_web, :boolean unless column_exists?(table, :available_on_web)
    add_index :product_types, :available_on_web unless index_exists?(table,:available_on_web )
  end
